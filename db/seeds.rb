...
ann = User.create(name: "Ann", github_profile: "https://github.com/", cohort_name: "Live fast pry young", cohort_start: Date.today)
carl = User.create(name: "Carl", github_profile: "https://github.com/cjp34", cohort_name: "Live fast pry young", cohort_start: Date.today)
paul = User.create(name: "Paul", github_profile: "https://github.com/bumbot", cohort_name: "Live fast pry young", cohort_start: Date.today)
matteo = User.create(name: "Matteo", github_profile: "https://github.com/matteoaricci", cohort_name: "Live fast pry young", cohort_start: Date.today)
bri = User.create(name: "Bri", github_profile: "https://github.com/briannalturner", cohort_name: "Live fast pry young", cohort_start: Date.today)
